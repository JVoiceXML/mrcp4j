...
public class CompletionCauseTest {
    ...
    public void testConstructorWithValidValues() {
        ...
        Assert.assertEquals("Cause code should match", causeCode, cause.getCauseCode());
        Assert.assertEquals("Cause name should match", causeName, cause.getCauseName());
        Assert.assertEquals("String representation should be formatted correctly", "200 success", cause.toString());
    }
    ...
    public void testConstructorWithSingleDigitCode() {
        ...
        Assert.assertEquals("Cause code should match", causeCode, cause.getCauseCode());
        Assert.assertEquals("Cause name should match", causeName, cause.getCauseName());
        Assert.assertEquals("String should be zero-padded", "005 test", cause.toString());
    }
    ...
    public void testConstructorWithDoubleDigitCode() {
        ...
        Assert.assertEquals("Cause code should match", causeCode, cause.getCauseCode());
        Assert.assertEquals("Cause name should match", causeName, cause.getCauseName());
        Assert.assertEquals("String should be zero-padded", "042 test", cause.toString());
    }
    ...
    public void testConstructorWithTripleDigitCode() {
        ...
        Assert.assertEquals("Cause code should match", causeCode, cause.getCauseCode());
        Assert.assertEquals("Cause name should match", causeName, cause.getCauseName());
        Assert.assertEquals("String should not be padded", "999 maxvalue", cause.toString());
    }
    ...
    public void testConstructorWithMinimumValues() {
        ...
        Assert.assertEquals("Cause code should match", causeCode, cause.getCauseCode());
        Assert.assertEquals("Cause name should match", causeName, cause.getCauseName());
        Assert.assertEquals("String should be formatted correctly", "000 a", cause.toString());
    }
    ...
    public void testConstructorWithCauseNameNeedingTrim() {
        ...
        Assert.assertEquals("Cause name should not be trimmed in getter", "  success  ", cause.getCauseName());
        Assert.assertEquals("String should use trimmed name", "200 success", cause.toString());
    }
    ...
    public void testEquals() {
        ...
        Assert.assertTrue("Same completion causes should be equal", cause1.equals(cause2));
        Assert.assertTrue("Should be reflexive", cause1.equals(cause1));
        Assert.assertFalse("Different causes should not be equal", cause1.equals(cause3));
        Assert.assertFalse("Different names should not be equal", cause1.equals(cause4));
        Assert.assertFalse("Should not equal null", cause1.equals(null));
        Assert.assertFalse("Should not equal different type", cause1.equals("string"));
    }
    ...
    public void testHashCode() {
        ...
        Assert.assertEquals("Same cause code should have same hash", cause1.hashCode(), cause2.hashCode());
        Assert.assertNotEquals("Different cause codes should have different hash", cause1.hashCode(), cause3.hashCode());
    ...
    public void testFactoryFromValueStringValid() throws IllegalValueException {
        ...
        Assert.assertTrue("Should return CompletionCause", result instanceof CompletionCause);
        CompletionCause cause = (CompletionCause) result;
        Assert.assertEquals("Cause code should match", 200, cause.getCauseCode());
        Assert.assertEquals("Cause name should match", "success", cause.getCauseName());
        Assert.assertEquals("String should match original", "200 success", cause.toString());
    }
    ...
    public void testFactoryFromValueStringWithPadding() throws IllegalValueException {
        ...
        Assert.assertTrue("Should return CompletionCause", result instanceof CompletionCause);
        CompletionCause cause = (CompletionCause) result;
        Assert.assertEquals("Cause code should match", 5, cause.getCauseCode());
        Assert.assertEquals("Cause name should match", "test", cause.getCauseName());
    }
    ...
    public void testFactoryEdgeCases() throws IllegalValueException {
        ...
        Assert.assertEquals("Should handle zero code", 0, cause1.getCauseCode());
        
        // Test maximum valid value
        Object result2 = factory.fromValueString("999 max");
        CompletionCause cause2 = (CompletionCause) result2;
        Assert.assertEquals("Should handle maximum code", 999, cause2.getCauseCode());
    }
}